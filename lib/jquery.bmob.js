            ...
            return {
                save: function (fSucess, fError) {
                    /*
                     $.ajax({
                     type: 'POST',
                     url:'https://api.bmob.cn/1/files/' + Base64.encode(title),
                     data: data,
                     processData: false,
                     beforeSend: function(XMLHttpRequest) {
                     XMLHttpRequest.setRequestHeader("X-Bmob-Application-Id",Bmob.app_key);
                     XMLHttpRequest.setRequestHeader("X-Bmob-REST-API-Key",Bmob.rest_key);
                     XMLHttpRequest.setRequestHeader("Content-Type","image/png");
                     },
